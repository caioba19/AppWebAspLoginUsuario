...
namespace AppWebAspLoginUsuario
{
    public partial class Register : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.ConnectionString = "Data Source=36DE250002\\SENAC;Initial Catalog=Meu_Projeto;Integrated Security=True";
            /* Abertura da Conexão */
            con.Open();
        ...
        protected void btnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "INSERT INTO usuarios(nome, sobrenome,  email, senha, cep, bairro, rua, numero, telefone )VALUES('" + txbNome.Text.ToString()+ "', '" + txbSobrenome.Text.ToString() + "', '" + txbEmail.Text.ToString() + "', '" + txbSenha.Text.ToString() + "', '" + txbCep.Text.ToString() + "', '" + txbEndereco1.Text.ToString() + "', '" + txbEndereco2.Text.ToString() + "', '" + txbEndereco3.Text.ToString() + "', '" + txbTelefone.Text.ToString() + "' )";
            ...
            txbNome.Text = txbSobrenome.Text = txbEmail.Text = txbSenha.Text = txbCep.Text = txbEndereco1.Text = txbEndereco2.Text = txbEndereco3.Text = txbTelefone.Text=  String.Empty;
        }
