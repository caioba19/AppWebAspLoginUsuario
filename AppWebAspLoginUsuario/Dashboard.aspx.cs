...
namespace AppWebAspLoginUsuario
{
    public partial class Dashboard : System.Web.UI.Page
    {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            dt = new DataTable();
            /* Comando SQL */
            cmd.CommandText = "UPDATE usuarios  SET email='" + txbEmail.Text.ToString() + "', senha='" + txbSenha.Text.ToString() + "' WHERE id_usuario='"+id_user+"'";
            /* Abre a Conexão */
            cmd.Connection = con;
            /* Executa a Query SQL */
            cmd.ExecuteNonQuery();
        ...
        public void dataShow()
        {
            ...
            /* Comando SQL */
            cmd.CommandText = "SELECT * FROM usuarios WHERE id_usuario='"+id_user+"'";
            /* Conexão com Banco */
            cmd.Connection = con;
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            dt = new DataTable();
            /* Comando SQL */
            cmd.CommandText = "DELETE usuarios WHERE id_usuario='" + id_user + "'";
            /* Abre a Conexão */
            cmd.Connection = con;
            /* Executa a Query SQL */
            cmd.ExecuteNonQuery();
